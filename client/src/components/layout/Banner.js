  ...
  return (
    <div className='banner-main' id='home'>
      <div className='banner-main-inner'>
        ...
        <div className='main-heading'>Promoting <span className='hellospanner'>&</span> Supporting Female <span className='hellospanner'>Entrepreuners</span>, Bringing Them <span className='hellospanner'>Together</span>. </div>
