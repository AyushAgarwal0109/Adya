    ...
    return ( 
        <div className="scheme-outer" align="center">
            ...
            <div class="card">
                ...
                <img class="image" style={{position: 'relative', top: '70px', height: '200px' }} src={Udham} alt="" />
                </div>
                <div class="back">
                <h3 class="synopsis">MAHILA UDYAM NIDHI SCHEME</h3>
                <p>
            ...
            <div class="card">
                ...
                <img class="image" style={{position: 'relative', top: '70px', height: '200px' }} src={Bmb} alt="" />
                </div>
                <div class="back">
                <h3 class="synopsis">BHARATIYA MAHILA BANK BUSINESS LOAN</h3>
            ...
            <div class="card">
                ...
                <img class="image" style={{position: 'relative', top: '70px', height: '200px' }} src={ds} alt="" />
                </div>
                <div class="back">
                <h3 class="synopsis">DENA SHAKTI SCHEME</h3>
                <p>
            ...
            <div class="card">
                ...
                <img class="image" style={{position: 'relative', top: '70px', height: '200px' }} src={mudra} alt="" />
                </div>
                <div class="back">
                <h3 class="synopsis">PRADHAN MANTRI ROZGAR YOJANA</h3>
            ...
            <div class="card">
                ...
                <img class="image" style={{position: 'relative', top: '70px', height: '200px' }} src={udyogini} alt="" />
                </div>
                <div class="back">
                <h3 class="synopsis">UDYOGINI <br/> SCHEME</h3>
            ...
            <div class="card">
                ...
                <img class="image" style={{position: 'relative', top: '70px', height: '200px' }} src={orient} alt="" />
                </div>
                <div class="back">
                <h3 class="synopsis">ORIENT MAHILA VIKAS YOJANA</h3>
